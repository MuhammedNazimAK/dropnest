  ...
  return (
    <div className="absolute top-4 left-1/2 -translate-x-1/2 z-20 bg-background shadow-lg rounded-lg p-2 flex items-center space-x-2 border border-border">
      ...
      {isTrashView ? (
        ...
        <>
          <button title="Restore" onClick={onRestore} className="p-2 hover:bg-accent rounded-md">
        ...
        <>
          <button title="Star" onClick={onToggleStar} className="p-2 hover:bg-accent rounded-md">
            <Star className="w-4 h-4" />
          </button>
          <button title="Move" onClick={onMove} className="p-2 hover:bg-accent rounded-md">
